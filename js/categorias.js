...
if (categoria) {
    fetch('../js/productos.json')
        ...
        .then(data => {
            ...
            let html = `<h1>Ropa y accesorios para ${categoria.charAt(0).toUpperCase() + categoria.slice(1)}</h1><div class="row" style="justify-content: center;">`;
    ...
    contenido.innerHTML = '<p>Selecciona una categoría del menú para ver contenido.</p>';
}